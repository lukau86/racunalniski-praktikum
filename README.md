...
- <i>Kopiraj</i> označeno v odložišče: <kbd>Ctrl+C</kbd> (**C**opy)
- <i>Izreži</i> označeno v odložišče: <kbd>Ctrl+X</kbd>
- <i>Prilepi</i> vsebino odložišča: <kbd>Ctrl+V</kbd>
- Prehajaj med odprtimi okni: <kbd>Alt+Esc</kbd>
- Odpri Upravitelja opravil: <kbd>Ctrl+Shift+Esc</kbd>
- Odpri okence za vnos čustvenčkov: <kbd>Windows+.</kbd>
...
0. [Moja prelepa spletna stran](https://lukau86.github.io/)
